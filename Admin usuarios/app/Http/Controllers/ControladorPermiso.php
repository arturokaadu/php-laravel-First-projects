    ...
    public function eliminar(Request $request) {
        ...
        if (Usuario::autenticado() == true) {
            if (Patente::autorizarOperacion("PATENTESBAJA")) {
                ...
                $entidadPatenteFamilia = new Patente_familia();
                $patenteId = $entidadPatenteFamilia->fk_idpatente;
                $familiaId = $entidadPatenteFamilia->fk_idfamilia;
                $entidadPatenteFamilia->eliminarPorFamilia($familiaId);

                $entidadPatente = new Patente();
                $entidadPatente->obtenerPorId($patenteId);
                $entidadPatente->eliminar();

                $entidadFamilia = new Familia();
                $entidadFamilia->obtenerPorId($familiaId);
                $entidadFamilia->eliminar();
